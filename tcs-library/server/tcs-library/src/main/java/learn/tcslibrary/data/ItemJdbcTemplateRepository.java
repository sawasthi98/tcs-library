...
public class ItemJdbcTemplateRepository implements ItemRepository {
    ...
    public Item findByItemId(int itemId) {
        final String sql = "select item_id, title, identifier, `description`, `subject`, filename, imgLink " +
...
//    }
    ...
    public List<Item> findItemsByItemShelf(ItemShelf itemShelf){
        final String sql = "  select i.item_id, i.title, i.identifier, i.filename, i.imgLink from item i " +
